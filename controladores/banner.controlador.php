		...
		if(isset($_POST["tipoBanner"])){
			...
			if(isset($_FILES["fotoBanner"]["tmp_name"]) && !empty($_FILES["fotoBanner"]["tmp_name"])){
				...
				if($_FILES["fotoBanner"]["type"] == "image/jpeg"){
					...
					$rutaBanner = "views/images/banner/".$_FILES["fotoBanner"]["name"].".jpg";
				...
				if($_FILES["fotoBanner"]["type"] == "image/png"){
					...
					$rutaBanner = "views/images/banner/".$_FILES["fotoBanner"]["name"].".png";
		...
		if(isset($_POST["editarTipoBanner"])){
			...
			if(isset($_FILES["fotoBanner"]["tmp_name"]) && !empty($_FILES["fotoBanner"]["tmp_name"])){
				...
				if($_FILES["fotoBanner"]["type"] == "image/jpeg"){
					...
					$rutaBanner = "views/images/banner/".$_POST["rutaBanner"].".jpg";
				...
				if($_FILES["fotoBanner"]["type"] == "image/png"){
					...
					$rutaBanner = "views/images/banner/".$_POST["rutaBanner"].".png";

		...
		for($i = 0; $i < count($subcategorias); $i++){
			...
			$cabeceras = ControladorCabeceras::ctrMostrarCabeceras($item2, $valor2);
  			...
  			if($cabeceras["portada"] != ""){
  				...
  				$imagenPortada = "<img src='views/images/cabeceras/default/default.jpg' class='img-thumbnail imgPortadaSubCategorias' width='100px'>";
  			}
			...
			if($subcategorias[$i]["oferta"] != 0){
  			...
  			if($subcategorias[$i]["imgOferta"] != ""){
	  			...
	  			$imgOferta = "<img src='views/images/ofertas/default/default.jpg' class='img-thumbnail imgTablaSubCategorias' width='100px'>";

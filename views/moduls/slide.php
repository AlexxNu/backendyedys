                ...
                <div class="tp-banner-container">
                    <div class="tp-banner slider-5">
                        ...
                        if($value["tipoSlide"] == "slideOpcion1"){
                                ...
                                echo '<img src="http://localhost/frontend/'.$value["imgFondo"].'"  alt="slidebg1" data-lazyload="http://localhost/frontend/'.$value["imgProducto"].'" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">';
                            ...
                            echo '</li>';
                                ...
                                <!-- MAIN IMAGE -->
                                <img src="http://localhost/frontend/'.$value["imgFondo"].'"  alt="slidebg1" data-lazyload="http://localhost/frontend/'.$value["imgProducto"].'" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">

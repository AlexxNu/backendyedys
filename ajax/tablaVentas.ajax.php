  ...
  public function mostrarTabla(){	
	...
	for($i = 0; $i < count($ventas); $i++){
		...
		if($traerCliente["foto"] != ""){
			...
			$imgCliente = "<img class='img-circle' src='views/images/usuarios/default/anonymous.png' width='70px'>";
		}
		...
		if($ventas[$i]["metodo"] == "paypal"){
			...
			$metodo = "<img class='img-responsive' src='views/images/plantilla/paypal.jpg' width='300px'>";
		
		}else if($ventas[$i]["metodo"] == "payu"){

			$metodo = "<img class='img-responsive' src='views/images/plantilla/payu.jpg' width='300px'>";

...
class ControladorProductos{
	...
	static public function ctrSubirMultimedia($datos, $ruta){
		...
		if(isset($datos["tmp_name"]) && !empty($datos["tmp_name"])){
			...
			$directorio = "../views/images/multimedia/".$ruta;
	...
	static public function ctrCrearProducto($datos){
		...
		if(isset($datos["tituloProducto"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $datos["tituloProducto"]) && preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["descripcionProducto"]) ){
				...
				$rutaPortada = "../views/images/cabeceras/default/default.jpg";
				...
				if(isset($datos["fotoPortada"]["tmp_name"]) && !empty($datos["fotoPortada"]["tmp_name"])){
					...
					if($datos["fotoPortada"]["type"] == "image/jpeg"){
						...
						$rutaPortada = "../views/images/cabeceras/".$datos["rutaProducto"].".jpg";
					...
					if($datos["fotoPortada"]["type"] == "image/png"){
						...
						$rutaPortada = "../views/images/cabeceras/".$datos["rutaProducto"].".png";
				...
				$rutaFotoPrincipal = "../views/images/productos/default/default.jpg";
				...
				if(isset($datos["fotoPrincipal"]["tmp_name"]) && !empty($datos["fotoPrincipal"]["tmp_name"])){
					...
					if($datos["fotoPrincipal"]["type"] == "image/jpeg"){
						...
						$rutaFotoPrincipal = "../views/images/productos/".$datos["rutaProducto"].".jpg";
					...
					if($datos["fotoPrincipal"]["type"] == "image/png"){
						...
						$rutaFotoPrincipal = "../views/images/productos/".$datos["rutaProducto"].".png";
				...
				if(isset($datos["fotoOferta"]["tmp_name"]) && !empty($datos["fotoOferta"]["tmp_name"])){
					...
					if($datos["fotoOferta"]["type"] == "image/jpeg"){
						...
						$rutaOferta = "../views/images/ofertas/".$datos["rutaProducto"].".jpg";
					...
					if($datos["fotoOferta"]["type"] == "image/png"){
						...
						$rutaOferta = "../views/images/ofertas/".$datos["rutaProducto"].".png";
	...
	static public function ctrEliminarProducto(){
		...
		if(isset($_GET["idProducto"])){
			...
			$borrar = glob("views/images/multimedia/".$_GET["rutaCabecera"]."/*");
			...
			rmdir("views/images/multimedia/".$_GET["rutaCabecera"]);

			/*=============================================
			ELIMINAR FOTO PRINCIPAL
			=============================================*/

			if($_GET["imgPrincipal"] != "" && $_GET["imgPrincipal"] != "views/images/productos/default/default.jpg"){
			...
			if($_GET["imgPortada"] != "" && $_GET["imgPortada"] != "views/images/cabeceras/default/default.jpg"){
